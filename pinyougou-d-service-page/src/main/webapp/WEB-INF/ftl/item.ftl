						...
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<#list spec.attributeValue as value>
									<dd><a href="javascript:;" ng-click="selectSpecification('${spec.attributeName}', '${value}')" class="{{isSelected('${spec.attributeName}', '${value}')?'selected':''}}">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="cart.html" target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addChart()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
