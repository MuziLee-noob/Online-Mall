...
public class SeckillOrderServiceImpl implements SeckillOrderService {
	...
	public void submitOrder(Long seckillId, String userId) {
		...
		System.out.println("向redis中保存订单数据");
	}
	 ...
	 */
	@Override
	public void saveOrderFromRedis2DB(String userId, Long orderId, String transactionId) {
	...
	@Override
	public void updateAddress(Long orderId, TbAddress address) {
