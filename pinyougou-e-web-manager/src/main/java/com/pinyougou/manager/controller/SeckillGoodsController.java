...
public class SeckillGoodsController {
	...
	@RequestMapping("/searchUnchecked")
	public PageResult searchUnchecked(@RequestBody TbSeckillGoods seckillGoods, int page, int rows) {
		return seckillGoodsService.findUnchecked(seckillGoods, page, rows);
	}
